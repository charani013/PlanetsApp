...
https://user-images.githubusercontent.com/90957976/140020647-d91178d5-2cef-47aa-b555-559230f93c5f.mp4
...
- The HTML container element with `data-testid` as `planets` should have the planets background image, which is mentioned in the image URLs
